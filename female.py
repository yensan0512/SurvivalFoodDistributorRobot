...
for i in range(254,130,-2):                              #arm turn to back
...
time.sleep(3)
m.run_to_rel_pos(position_sp=-90, speed_sp=70, stop_action="hold")  #arm turn up
time.sleep(6)


for i in range(130,254,2):                                        #arm turn to front
    servoT.write_i2c_block_data(0x01, 0x42, [i])
    time.sleep(0.1)
time.sleep(1)
